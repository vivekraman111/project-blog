...
(async () => {
  var fileNames = await fs.readdir("./content");
  var frontmatter = await Promise.all(
    fileNames.map(async (fileName) => {
      var rawContent = await fs.readFile(`./content/${fileName}`, "utf8");
...
/*
"constants.js": `export const BLOG_TITLE = 'Bits & Bytes';
